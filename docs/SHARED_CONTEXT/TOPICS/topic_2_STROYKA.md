...
GENERATED_AT: 2026-07-08T10:00:02.215809+00:00
...
- MANUAL_RERUN_AFTER_TOPIC2_CONFIRM_MERGE_FIX
- FULL_STROYKA_ESTIMATE_CANON_CLOSE_V3:clarification
- TOPIC2_MISSING_GATE_ANTILOOP_BLOCKED_DEFAULTS:count=3
- MANUAL_RERUN_AFTER_TOPIC2_MULTIFILE_HYDRATE_FIX
- TOPIC2_MULTIFILE_PROJECT_PDF_ATTACHED:Раздел 4 - КР.pdf
- TOPIC2_MULTIFILE_PROJECT_PDF_ATTACHED:Раздел 3 - АР.pdf
- TOPIC2_MULTIFILE_PROJECT_CONTEXT_READY:2_pdf
- TOPIC2_PDF_TEXT_FACTS_ENRICHED:scope
- TOPIC2_MISSING_GATE_ANTILOOP_BLOCKED_DEFAULTS:count=4
- clarified:да
- TOPIC2_MISSING_GATE_ANTILOOP_BLOCKED_DEFAULTS:count=5
- state:FAILED
- reply_sent:stale_failed
- PATCH_GLOBAL_HISTORICAL_MEMORY_RECALL_V1:core_tasks=d72028da,95593050,ba3cbab3
- MANUAL_RERUN_AFTER_OCR_MEMORY_GUARD_FIX
- TOPIC2_MULTIFILE_PROJECT_SPEC_ROWS:Раздел 4 - КР.pdf:1
- TOPIC2_MULTIFILE_PROJECT_CONTEXT_FROM_ATTACHMENT:1_file
- MANUAL_RERUN_AFTER_PDF_SPEC_PARSER_FIX
- MANUAL_RERUN_AFTER_PDF_OCR_PAGE_SELECTION_FIX
- MANUAL_RERUN_AFTER_MULTIFILE_OCR_TIMEOUT_FIX
- TOPIC2_MULTIFILE_PROJECT_OCR_STATUS_SENT
- TOPIC2_MULTIFILE_PROJECT_SPEC_ROWS:Раздел 4 - КР.pdf:13
- MANUAL_RERUN_AFTER_CONFIRM_RAW_MERGE_FIX
- MANUAL_RERUN_AFTER_PARSE_CONFIRM_FIELDS_FIX
- MANUAL_RERUN_AFTER_PROFILE_ELEMENT_MASS_GUARD
- TOPIC2_MULTIFILE_PROJECT_SPEC_ROWS:Раздел 4 - КР.pdf:2
- MANUAL_RERUN_AFTER_KR_TABLE_OCR_PARSER_FIX

# ONE_SHARED_CONTEXT
updated_at: 2026-04-30T08:00:01+00:00
...
- docs/REPORTS/MASTER_CLOSURE_PLAN.md [BROKEN]
...
| 2. §0.5 — соблюдён порядок: BAK → patch → py_compile → restart → sleep → is-acti | docs/CANON_FINAL/01_SYSTEM_LOGIC_FULL.md | INSTALLED |
...
| ⚠️ PATCH_CRASH_BOTMSG_V1 | docs/REPORTS/CANON_CLOSURE_PLAN.md | UNKNOWN |
| ⚠️ PATCH_RETRY_TG_MSG_V1 | docs/REPORTS/CANON_CLOSURE_PLAN.md | UNKNOWN |
| ⚠️ PATCH_DAEMON_USE_OAUTH_V1 | docs/REPORTS/CANON_CLOSURE_PLAN.md | UNKNOWN |
| ⚠️ PATCH_VOICE_OAUTH_V1 | docs/REPORTS/CANON_CLOSURE_PLAN.md | UNKNOWN |
| ⚠️ PATCH_DUPLICATE_GUARD_V1 | docs/REPORTS/CANON_CLOSURE_PLAN.md | UNKNOWN |
| ⚠️ PATCH_MULTI_FILE_INTAKE_V1 | docs/REPORTS/CANON_CLOSURE_PLAN.md | UNKNOWN |
| ⚠️ PATCH_LINK_INTAKE_NEEDS_CONTEXT_V1 | docs/REPORTS/CANON_CLOSURE_PLAN.md | UNKNOWN |
| ### PASS 1 — PATCH_CONFIRM_ONLY_ON_DONE_V1 | docs/REPORTS/CANON_CLOSURE_PLAN.md | UNKNOWN |
| ### PASS 2 — PATCH_TEMPLATE_INTENT_V1 | docs/REPORTS/CANON_CLOSURE_PLAN.md | UNKNOWN |
...
- 8. BROKEN/REJECTED/UNKNOWN → не использовать [docs/REPORTS/CANON_CLOSURE_PLAN.md]
- 8. BROKEN/REJECTED/UNKNOWN — НЕ использовать как канон [docs/REPORTS/NOT_CLOSED.md]
- 4. BROKEN/REJECTED/UNKNOWN — не использовать [docs/REPORTS/NOT_CLOSED.md]
...
Если норма не найдена → "норма не подтверждена", не выдумыв
...[TRUNCATED]
